...
export function MediaIcon({ fill }) {
    return (
...
export function EmojiIcon({ fill }) {
    return (
        <svg viewBox={"0 0 24 24"} aria-hidden={"true"} className={fill}>
            <g>
...
export function ScheduleIcon({ fill }) {
    return (
        <svg viewBox={"0 0 24 24"} aria-hidden={"true"} className={fill}>
            <g>
...
export function LocationIcon({ fill }) {
    return (
        <svg viewBox={"0 0 24 24"} aria-hidden={"true"} className={fill}>
            <g>
...
export function ReplyIcon({ fill }) {
    return (
        <svg viewBox={"0 0 24 24"} aria-hidden={"true"} className={fill}>
            <g>
...
export function RetweetIcon({ fill }) {
    return (
        <svg viewBox={"0 0 24 24"} aria-hidden={"true"} className={fill}>
            <g>
...
export function ShareIcon({ fill }) {
    return (
        <svg viewBox={"0 0 24 24"} aria-hidden={"true"} className={fill}>
            <g>
