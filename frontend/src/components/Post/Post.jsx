      ...
      <div className="mx-auto shadow-md bg-white font-bold rounded-md mb-14 w-2/5">
            <div className="flex flex-row px-2 py-3 mx-3">
                <div className="w-auto h-auto rounded-full">
                    <img className="w-12 h-12 object-cover rounded-full shadow cursor-pointer" alt="User avatar" src={Profile}/>
                </div>
            ...
            <div className="flex justify-start  mb-4 border-t border-gray-100">
                <div className="flex w-full mt-1 pt-2 pl-5">
                    <span className="transition ease-out duration-300 active:bg-gray-700  h-8 px-2 py-1 text-center rounded-full text-gray-100 cursor-pointer">
                        <SVGComment/>
                    </span>
                ...
                <div className="flex justify-end w-full mt-1 pt-2 pr-5">
                    <span className="transition ease-out duration-300 active:bg-gray-700  w-8 h-8 px-1 py-1 text-center rounded-full text-blue-400 cursor-pointer mr-2">
                        <SVGShare/>
                    </span>
                    <span className="transition ease-out duration-300 active:bg-red-700  h-8 px-2 py-1 text-center rounded-full text-gray-100 cursor-pointer">
                        <SVGLike/>
                    </span>
                </div>
            </div>
