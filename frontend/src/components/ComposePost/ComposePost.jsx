        ...
        <div className="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true">
            <div className="relative inset-0 overflow-auto">
                <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    <div
                        className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-md transition-all sm:my-8 sm:w-full sm:max-w-lg">
                        ...
                        <div className="bg-white px-4 py-3 sm:flex sm:justify-between sm:px-6">
                            <Gallery/>
                            <ButtonNoClassName
                                className={"inline-flex justify-center rounded-full border border-transparent " +
                                    "bg-blue-800 px-4 py-2 text-base font-medium text-white shadow-sm" +
